                            ...
                            ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <form method="post" action="wbd_detail.php">
                                            ...
                                            <button type="submit" class="btn btn-success btn-sm editbtn"><i class="fa fa-solid fa-check"></i>Submit WBS</span></button>
                                        </form>
                                        </td>
                                        <td>
                                        
                                        <form method="post" action="wbd_notapproved.php">
                                            <input type="hidden" name="E_id" id="E_id" value="<?php echo $RegValue['E_id']; ?>">
                                        ...
                                        <!-- <td> Approval </td> -->
                                        <td>
                                                <button type="submit" class="btn btn-info btn-sm editbtn" data-toggle="modal" data-target="#editModal2<?php echo $RegValue['id'] ?>"><i class="fa fa-solid fa-binoculars"></i>View Detail</span></button>
                                                <button type="submit" class="btn btn-success btn-sm editbtn1" data-toggle="modal" data-target="#editModal1<?php echo $RegValue['id'] ?>"><span class="glyphicon glyphicon-edit">Edit</span></button>
