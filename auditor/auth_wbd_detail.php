...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-10">
            ...
            ?>
            <div class="col-sm-10">
                <a href="../tm/view_aud_program_wbs.php" class="btn btn-outline-success"><i class="fa fa-arrow-circle-left"></i> &nbsp;Back</a>&nbsp;
                <a href="#" class="btn btn-outline-success"><i class="fa-regular fa fa-rotate-right"></i> &nbsp;Refresh</a>&nbsp;
                <h5 class="page-header">View work Breakdown Detail</h5>
