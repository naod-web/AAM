...
$viewEn = $oms->view_engagement( $Shared_EId_array );
...
<h5 class = 'page-header'>Engagement</h5>
</div>
<!-- /.col-lg-12 -->
</div>
...
if ( $viewEn ) {
    foreach ( $viewEn as $chValue ) {
        ...
        ?>
        <tr class = 'odd gradeX'>
        <td><?php echo $chValue[ 'id' ];
        ?></td>
        <td><?php echo $chValue[ 'p_id' ];
        ?></td>
        <td><?php echo $chValue[ 'auditee' ];
        ?></td>
        <td><?php echo $chValue[ 'Description' ];
        ?></td>
        <td><?php echo $chValue[ 'Assignment_date' ];
        ?></td>
        <td><?php echo $chValue[ 'S_date' ];
        ?></td>
        <td><?php echo $chValue[ 'E_date' ];
        ?></td>
        <!-- <td>
        <button type = 'submit' class = 'btn btn-primary btn-sm editbtn' data-toggle = 'modal' data-target = '#editModalAP'><span class = 'glyphicon glyphicon-edit'></span>Audit Program</button>
        </td> -->
        <!-- <td>
        ...
        if ( isset( $op ) ) {
            foreach ( $op as $value ) {
                ?>
                <option value = "<?php echo $value['Operational_area']; ?>"> <?php echo $value[ 'Operational_area' ];
                ?> </option>
                <?php }
            }
            ?>
