...
if (isset($_POST['create'])) {
    $savech = $oms->add_temp_team($_POST);
}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Audit Type:</label>
                                                                <input type="text" name="audit_type" id="audit_type" class="form-control" value="<?php echo $chValue['audit_type'] ?>">
                                                                <?php
                                                            if (isset($savech['audit_type'])) {
                                                                echo $savech['audit_type'];
                                                            }
                                                            ?>
                                                        </div>
                                                        <div class="form-group">
