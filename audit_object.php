...
$viewEn = $oms->select_audit_objects();
$op = $oms->select_operational();
$viewch = $oms->view_chAO($_SESSION['audit_type']);
...
if (isset($_POST['aod'])) {
    $saveReg = $oms->aod_audit_object($_POST);
}
if (isset($_POST['chk'])) {
    $savec = $oms->chk($_POST);
}
...
<div id="page-wrapper">
    ...
    <div class="row">
        ...
        <a href="audit_object.php" class="btn btn-outline-success"><i class="fa-regular fa fa-rotate-right"></i> &nbsp;Refresh</a>&nbsp;
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-eg20">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Audit Object</th>
