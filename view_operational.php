...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-sm-10">
        <a href="view_operational.php" class="btn btn-outline-success"><i class="fa fa-arrow-circle-left"></i> &nbsp;Back</a>&nbsp;
        <a href="view_operational.php" class="btn btn-outline-success"><i class="fa-regular fa fa-rotate-right"></i> &nbsp;Refresh</a>&nbsp;
        </div>
    </div>
                            ...
                            ?>
                                    ...
                                    <div class="modal fade" id="editModal4<?php echo $chValue['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Approve Operational Area</h5>
                                                    <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                                                </div>
                                                <form role="form" method="POST" action="#">
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" name="op" class="btn btn-info" value="op"><i class="fa fa-solid fa-check"></i>Approve</button>
