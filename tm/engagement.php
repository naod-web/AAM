...
if (isset($_POST['create'])) {
    $saveAH = $oms->add_temp_team($_POST);
}
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-10">
            ...
            <h5 class="page-header">Engagements</h5>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                            <button type="submit" class="btn btn-info btn-sm editbtn" data-toggle="modal" data-target="#editModal2<?php echo $chValue['id'] ?>"><span class="glyphicon glyphicon-plus">Add Auditors</span></button>
                                            </td>
                                            <td>
                                                    ...
                                                    <form method="post" action="#">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <input type="hidden" name="name" id="name" class="form-control" value="<?php echo $chValue['name'] ?> " readonly="readonly"  >
                                                                <div class="form-group">
                                                                    <label>Enagement ID:</label>
                                                                    <input type="text" name="E_id" id="E_id" class="form-control" value="<?php echo $chValue['id'] ?> " readonly="readonly"  >
                                                                    <?php
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="Team_member[]" class="form-control mul" multiple="multiple">
                                                                        <option class="hidden" value="">--- Select ---</option>
                                                                        <?php
                                                                        $con = mysqli_connect("localhost", "root", "", "oms");
                                                                        $query = "SELECT * FROM employee WHERE designation='AUDITOR'";
                                                        ...
                                                        <form role="form" method="POST" action="#">
                                                            <div class="modal-body">
                                                                ...
                                                                <!-- <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="audit_type" id="audit_type" class="form-control" value="" placeholder="Enter audit type">
